<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminmembermanagement.aspx.cs" Inherits="Pathshala.adminmembermanagement" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col">
                         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=DESKTOP-NASJ1VL\SQLEXPRESS;Initial Catalog=elibraryDB;Integrated Security=True;TrustServerCertificate=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [member_master_tbl]"></asp:SqlDataSource>
